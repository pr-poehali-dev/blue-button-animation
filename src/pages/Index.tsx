    ...
    <div className="min-h-screen bg-background text-foreground">
      <nav className="fixed top-0 left-0 h-full flex flex-col gap-4 p-8 z-50">
        <button
          ...
          className="group relative px-8 py-4 bg-primary text-primary-foreground rounded-xl font-semibold transition-all duration-300 ease-out hover:translate-x-2 hover:scale-110 hover:shadow-2xl hover:shadow-primary/50"
        >
          <span className="relative z-10">Биндер</span>
        ...
        <button
          ...
          className="group relative px-8 py-4 bg-primary text-primary-foreground rounded-xl font-semibold transition-all duration-300 ease-out hover:translate-x-2 hover:scale-110 hover:shadow-2xl hover:shadow-primary/50"
        >
          <span className="relative z-10">Справочник</span>
          <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </button>
        ...
        <button
          ...
          className="group relative px-8 py-4 bg-primary text-primary-foreground rounded-xl font-semibold transition-all duration-300 ease-out hover:translate-x-2 hover:scale-110 hover:shadow-2xl hover:shadow-primary/50"
        >
          <span className="relative z-10">Всё для новичков</span>
          <div className="absolute inset-0 bg-gradient-to-r from-primary to-secondary rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        </button>
      </nav>
